...
describe('markdown renderer', () => {
  it('adds metadata, summary and JUnit execution status to documented tests', () => {
    ...
    expect(md).toContain('| deve abrir a tela<br>Tela: Login<br>Prioridade: alta | Código: `await element(by.id(\'email\')).typeText(\'a@b.com\')` | Código: `await expect(element(by.id(\'homeScreen\'))).toBeVisible()` | OK (2s) |');
